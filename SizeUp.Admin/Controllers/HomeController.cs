    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            using (var context = ContextFactory.SizeUpContext)
            {
                ...
                var x = Core.DataLayer.IndustryData.GetMinimumBusinessCount(context).Where(i => i.IndustryId == 8589 && i.GeographicLocation.City.Name == "san francisco").FirstOrDefault();
