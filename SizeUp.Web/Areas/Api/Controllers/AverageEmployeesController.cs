...
namespace SizeUp.Web.Areas.Api.Controllers
{
    public class AverageEmployeesController : BaseController
    {
        ...
        public ActionResult AverageEmployees(long industryId, long placeId)
        {
            ...
            {
                var data = Core.DataLayer.AverageEmployees.Chart(context, industryId, placeId);
        ...
        public ActionResult Percentile(long industryId, long placeId, long value)
        {
            using (var context = ContextFactory.SizeUpContext)
            {
                var obj = Core.DataLayer.AverageEmployees.Percentile(context, industryId, placeId, value);
