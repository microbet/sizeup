(function () {
    ...
    sizeup.views.community.stateCommunity = function (opts) {
        ...
        dataLayer.getBoundingBox({ id: opts.CurrentPlace.State.Id, granularity: 'State' }, notifier.getNotifier(function (data) { me.data.BoundingBox = data; }));
        dataLayer.getCentroid({ id: opts.CurrentPlace.State.Id, granularity: 'State' }, notifier.getNotifier(function (data) { me.data.CityCenter = new sizeup.maps.latLng({ lat: data.Lat, lng: data.Lng }); }));
