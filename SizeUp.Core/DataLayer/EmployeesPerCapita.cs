    ...
    public class EmployeesPerCapita : Base.Base
    {
        public static PlaceValues<BarChartItem<double?>> Chart(SizeUpContext context, long industryId, long placeId)
        {
            var data = IndustryData.GetMinimumBusinessCount(context, industryId)
                ...
                {
                    City = i.City.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0)
                            .Select(d => new BarChartItem<double?>
                            {
                                Value = d.EmployeesPerCapita,
                                Median = null,
                                Name = d.City.Name + ", " + d.City.State.Abbreviation
                            }).FirstOrDefault(),

                    County = i.County.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0)
                            .Select(d => new BarChartItem<double?>
                            {
                                Value = d.EmployeesPerCapita,
                                Median = null,
                    ...
                    Metro = i.Metro.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0)
                            .Select(d => new BarChartItem<double?>
                            {
                                Value = d.EmployeesPerCapita,
                                Median = null,
                    ...
                    State = i.State.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0)
                            .Select(d => new BarChartItem<double?>
                            {
                                Value = d.EmployeesPerCapita,
                                Median = null,
                    ...
                    Nation = i.Nation.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0)
                            .Select(d => new BarChartItem<double?>
                            {
                                Value = d.EmployeesPerCapita,
                                Median = null,
            ...
            var data = context.CityCountyMappings
                ...
                .Select(i => new
                {
                    County = new
                    {
                        ...
                        Total = i.County.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Count(),
                        Filtered = i.County.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Where(d => d.EmployeesPerCapita <= i.City.Select(v=>v.EmployeesPerCapita).FirstOrDefault()).Count()
                    },
                    Metro = new
                    {
                        Metro = i.Place.County.Metro,
                        Total = i.Metro.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Count(),
                        Filtered = i.Metro.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Where(d => d.EmployeesPerCapita <= i.City.Select(v => v.EmployeesPerCapita).FirstOrDefault()).Count()
                    },
                    State = new
                    {
                        State = i.Place.County.State,
                        Total = i.State.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Count(),
                        Filtered = i.State.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Where(d => d.EmployeesPerCapita <= i.City.Select(v => v.EmployeesPerCapita).FirstOrDefault()).Count()
                    },
                    Nation = new
                    {
                        Total = i.Nation.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Count(),
                        Filtered = i.Nation.Where(d => d.EmployeesPerCapita != null && d.EmployeesPerCapita > 0).Where(d => d.EmployeesPerCapita <= i.City.Select(v => v.EmployeesPerCapita).FirstOrDefault()).Count()
                    }
                })
