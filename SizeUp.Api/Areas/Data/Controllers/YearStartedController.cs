...
namespace SizeUp.Api.Areas.Data.Controllers
{
    public class YearStartedController : BaseController
    {
        ...
        {
            // TODO integrate AccessibilityController.YearStarted.
            // Either geographicLocationId or placeId must be not -1, and we vary behavior based on which it is.
            // Ideally contentType could vary independently of that.
            if (startYear < 1986)
            {
                startYear = 1986;
            }
